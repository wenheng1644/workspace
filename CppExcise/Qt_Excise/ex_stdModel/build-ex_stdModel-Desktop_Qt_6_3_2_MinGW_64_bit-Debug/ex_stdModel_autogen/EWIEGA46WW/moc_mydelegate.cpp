...
#include <memory>
#include "../../../ex_stdModel/mydelegate.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MyDelegate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject MyDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyDelegate.offsetsAndSizes,
    qt_meta_data_MyDelegate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyDelegate_t
, QtPrivate::TypeAndForceComplete<MyDelegate, std::true_type>
