...
#include <memory>
#include "../../../ex_modelPro1/infotablemodel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_InfoTableModel_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_InfoTableModel_t qt_meta_stringdata_InfoTableModel = {
    {
        QT_MOC_LITERAL(0, 14)   // "InfoTableModel"
    },
    "InfoTableModel"
};
...
const QMetaObject InfoTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_InfoTableModel.offsetsAndSizes,
    qt_meta_data_InfoTableModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_InfoTableModel_t
, QtPrivate::TypeAndForceComplete<InfoTableModel, std::true_type>
